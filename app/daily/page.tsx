...
//   // Fallback to JSON
//   const entries = (dailyContentData as any)[day]
//   return Array.isArray(entries) ? (entries as DailyContent[]) : []
// }
...
//   const todayKey  = DAY_IDX[todayIdx]                    // e.g. 'wednesday'

//   // Only allow days up to today — clamp future days back to today
//   const requestedDay = searchParams.day || todayKey
//   const requestedIdx = DAY_IDX.indexOf(requestedDay)

//   // If requested day is in the future this week, fall back to today
